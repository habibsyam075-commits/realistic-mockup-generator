...
const ResultDisplay: React.FC<ResultDisplayProps> = ({ mockupImage, onReset, onRegenerate, onAdjust }) => {
  ...
  return (
    <div className="w-full flex flex-col items-center text-center">
      ...
      <p className="text-gray-400 mb-6">Here is the AI-generated preview of your engraved wallet.</p>
